...
private:
  ...
  PHG4Hitv1* GetBotVerticesFromStripe(int petalID, int moduleID, int radiusID, int stripeID);
  PHG4Hitv1* GetTopVerticesFromStripe(int petalID, int moduleID, int radiusID, int stripeID);
