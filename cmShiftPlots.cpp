...
TH2F *hCartesianDiff[6];
  ...
  TCanvas *c=new TCanvas("c","ShiftPlots",1500,1300);
  // x plots
  c->Divide(3,2);
  c->cd(1);
  ...
  { TLatex * xtitle = new TLatex(0.05,1.2,"X Shift Model"); xtitle->SetNDC(); xtitle->SetTextSize(0.1); xtitle->Draw(); }
  ...
  { TLatex * ytitle = new TLatex(0.05,1.2,"Y Shift Model"); ytitle->SetNDC(); ytitle->SetTextSize(0.1); ytitle->Draw(); }
  c->Print("ShiftPlots.pdf","pdf");
  ...
  { TLatex * ztitle = new TLatex(0.05,1.2,"Z Shift Model"); ztitle->SetNDC(); ztitle->SetTextSize(0.1); ztitle->Draw(); }
  c->Print("ShiftPlots.pdf","pdf");
  ...
  { TLatex * rtitle = new TLatex(0.05,1.2,"R Shift Model"); rtitle->SetNDC(); rtitle->SetTextSize(0.1); rtitle->Draw(); }
  c->Print("ShiftPlots.pdf","pdf");
  ...
  { TLatex * rcarttitle = new TLatex(0.05,1.2,"R Shift from Cartesian Model"); rcarttitle->SetNDC(); rcarttitle->SetTextSize(0.1); rcarttitle->Draw(); }
  c->Print("ShiftPlots.pdf","pdf");
  ...
  { TLatex * rcomptitle = new TLatex(0.05,1.2,"Comparing R Models"); rcomptitle->SetNDC(); rcomptitle->SetTextSize(0.1); rcomptitle->Draw(); }
  c->Print("ShiftPlots.pdf","pdf");
  ...
  { TLatex * phititle = new TLatex(0.05,1.2,"Phi Shift Model"); phititle->SetNDC(); phititle->SetTextSize(0.2); phititle->SetTextSize(0.2); phititle->Draw(); }
  c->Print("ShiftPlots.pdf)","pdf");
